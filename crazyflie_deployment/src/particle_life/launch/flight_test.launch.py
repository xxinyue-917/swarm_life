"""Launch the single-drone box flight test alongside the Crazyswarm2 server
and a rosbag recorder.

Outputs land in <repo>/results/flights/:
  flight_test_<timestamp>/        rosbag (Vicon /poses, /cfN/pose, /tf, /rosout)
  flight_test_<timestamp>.log     tee of every launched process's stdout/stderr
"""
import datetime
import os
...
def generate_launch_description():
    ...
    bag_path = os.path.join(BAG_ROOT, f'flight_test_{stamp}')
