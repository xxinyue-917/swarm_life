...
Outputs land in <repo>/results/flights/:
  hover_all_<timestamp>/        rosbag (Vicon /poses, /cfN/pose, /tf, /rosout)
  hover_all_<timestamp>.log     tee of every launched process's stdout/stderr
"""
import datetime
import os
...
def generate_launch_description():
    ...
    bag_path = os.path.join(BAG_ROOT, f'hover_all_{stamp}')
